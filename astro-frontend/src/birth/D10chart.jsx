...
const D10chart = () => {
    ...
    if (astrologyData) {
      ...
      const fetchD10Chart = async () => {
        try {
          ...
          setError('Error fetching D10 chart data'); // Handle errors
        }
      };

      fetchD10Chart(); // Trigger API call
    }
  ...
  if (!chartData) {
    return <div>Loading D10 Chart...</div>; // Loading state
  }
